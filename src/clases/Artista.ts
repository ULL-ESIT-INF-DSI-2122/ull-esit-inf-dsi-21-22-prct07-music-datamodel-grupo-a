...
export class Artista{
     ...
     */
    constructor(private nombre:string, private grupos:Grupo[], private generos:GeneroMusical[], private albumes:Album[], private canciones:Cancion[], private oyentes:number){
