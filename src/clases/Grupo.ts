...
export class Grupo{
     ...
     */
    constructor(private nombre:string, private artistas:string[], private año:string, private generos:GeneroMusical[], private albumes:string[], private oyentes:number){
